			...
			<div className="App">
				<Slider {...settings}>
					{photos.map((photo) => {
						return (
							<div>
								<img width="100%" src={photo.url} alt="lorem ipsum" />
								<p>{photo.info}</p>
							</div>
						);
					})}
